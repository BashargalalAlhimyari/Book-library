...
final class NewsBooksCubitPaginationLoading extends NewsBooksState {}

final class NewsBooksCubitPaginationFailure extends NewsBooksState {
  NewsBooksCubitPaginationFailure({required this.errMessage});
