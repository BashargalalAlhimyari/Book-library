...
class FetchQuickReadBooksUseCase extends UseCase<BooksList, int> {
  final HomeRepo _homeRepo;

  FetchQuickReadBooksUseCase(this._homeRepo);

  @override
  ResultFuture<BooksList> call([int param = AppConstants.itemsPerPage]) async {
    return await _homeRepo.fetchQuickReadBooks(pageNumber: param);
  }
}
